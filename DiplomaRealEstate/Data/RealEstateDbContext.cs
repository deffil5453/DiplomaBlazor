...
namespace BlazorApp10.Data
{
    public class RealEstateDbContext : IdentityDbContext<User>
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=localhost\\MSSQLSERVERR; database=Diploma;Trusted_Connection=true;Integrated Security=true;TrustServerCertificate=true");
